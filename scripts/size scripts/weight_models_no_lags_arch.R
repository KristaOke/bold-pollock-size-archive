#=====================================================================================================
#runs main models used in manuscript
#=====================================================================================================
...
cr1 <- getViz(base.null1_ran$gam)
pcr1 <- plot(sm(cr1, 2)) + l_fitRaster() + l_fitContour() + labs(title = NULL) + #l_points() +
  geom_polygon(data = map_data ("world"), 
               aes(x=long, y = lat,group=group),fill="white",color="black",
               inherit.aes = F)+coord_sf(xlim = c(-177, -158.5), ylim = c(54.5, 62), expand = FALSE) +
  scale_fill_distiller(palette = "Spectral", type = "div", limits = c(-3,3)) +
...
cr2 <- getViz(base.null2_ran$gam)
pcr2 <- plot(sm(cr2, 2)) + l_fitRaster() + l_fitContour() + labs(title = NULL) + #l_points() +
  geom_polygon(data = map_data ("world"), 
               aes(x=long, y = lat,group=group),fill="white",color="black",
               inherit.aes = F)+coord_sf(xlim = c(-177, -158.5), ylim = c(54.5, 62), expand = FALSE) +
  scale_fill_distiller(palette = "Spectral", type = "div", limits = c(-3,3)) +
...
cr3 <- getViz(base.null3_ran$gam)
pcr3 <- plot(sm(cr3, 2)) + l_fitRaster() + l_fitContour() + labs(title = NULL) + #l_points() +
  geom_polygon(data = map_data ("world"), 
               aes(x=long, y = lat,group=group),fill="white",color="black",
               inherit.aes = F)+coord_sf(xlim = c(-177, -158.5), ylim = c(54.5, 62), expand = FALSE) +
  scale_fill_distiller(palette = "Spectral", type = "div", limits = c(-3,3)) +
...
cr4 <- getViz(base.null4_ran$gam)
pcr4 <- plot(sm(cr4, 2)) + l_fitRaster() + l_fitContour() + labs(title = NULL) + #l_points() +
  geom_polygon(data = map_data ("world"), 
               aes(x=long, y = lat,group=group),fill="white",color="black",
               inherit.aes = F)+coord_sf(xlim = c(-177, -158.5), ylim = c(54.5, 62), expand = FALSE) +
  scale_fill_distiller(palette = "Spectral", type = "div", limits = c(-3,3)) +
...
cr5 <- getViz(base.null5_ran$gam)
pcr5 <- plot(sm(cr5, 2)) + l_fitRaster() + l_fitContour() + labs(title = NULL) + #l_points() +
  geom_polygon(data = map_data ("world"), 
               aes(x=long, y = lat,group=group),fill="white",color="black",
               inherit.aes = F)+coord_sf(xlim = c(-177, -158.5), ylim = c(54.5, 62), expand = FALSE) +
  scale_fill_distiller(palette = "Spectral", type = "div", limits = c(-3,3)) +
...
cr6 <- getViz(base.null6_ran$gam)
pcr6 <- plot(sm(cr6, 2)) + l_fitRaster() + l_fitContour() + labs(title = NULL) + #l_points() +
  geom_polygon(data = map_data ("world"), 
               aes(x=long, y = lat,group=group),fill="white",color="black",
               inherit.aes = F)+coord_sf(xlim = c(-177, -158.5), ylim = c(54.5, 62), expand = FALSE) +
  scale_fill_distiller(palette = "Spectral", type = "div", limits = c(-3,3)) +
...
cr7 <- getViz(base.null7_ran$gam)
pcr7 <- plot(sm(cr7, 2)) + l_fitRaster() + l_fitContour() + labs(title = NULL) + #l_points() +
  geom_polygon(data = map_data ("world"), 
               aes(x=long, y = lat,group=group),fill="white",color="black",
               inherit.aes = F)+coord_sf(xlim = c(-177, -158.5), ylim = c(54.5, 62), expand = FALSE) +
  scale_fill_distiller(palette = "Spectral", type = "div", limits = c(-3,3)) +
...
cr8 <- getViz(base.null8_ran$gam)
pcr8 <- plot(sm(cr8, 2)) + l_fitRaster() + l_fitContour() + labs(title = NULL) + #l_points() +
  geom_polygon(data = map_data ("world"), 
               aes(x=long, y = lat,group=group),fill="white",color="black",
               inherit.aes = F)+coord_sf(xlim = c(-177, -158.5), ylim = c(54.5, 62), expand = FALSE) +
  scale_fill_distiller(palette = "Spectral", type = "div", limits = c(-3,3)) +
...
cr9 <- getViz(base.null9_ran$gam)
pcr9 <- plot(sm(cr9, 2)) + l_fitRaster() + l_fitContour() + labs(title = NULL) + #l_points() +
  geom_polygon(data = map_data ("world"), 
               aes(x=long, y = lat,group=group),fill="white",color="black",
               inherit.aes = F)+coord_sf(xlim = c(-177, -158.5), ylim = c(54.5, 62), expand = FALSE) +
  scale_fill_distiller(palette = "Spectral", type = "div", limits = c(-3,3)) +
...
cr10 <- getViz(base.null10_ran$gam)
pcr10 <- plot(sm(cr10, 2)) + l_fitRaster() + l_fitContour() + 
  labs(title = NULL) + #l_points() +
  geom_polygon(data = map_data ("world"), 
               aes(x=long, y = lat,group=group),fill="white",color="black",
               inherit.aes = F)+coord_sf(xlim = c(-177, -158.5), ylim = c(54.5, 62), expand = FALSE) +
...
cr11 <- getViz(base.null11_ran$gam)
pcr11 <- plot(sm(cr11, 2)) + l_fitRaster() + l_fitContour() + labs(title = NULL) + #l_points() +
  geom_polygon(data = map_data ("world"), 
               aes(x=long, y = lat,group=group),fill="white",color="black",
               inherit.aes = F)+coord_sf(xlim = c(-177, -158.5), ylim = c(54.5, 62), expand = FALSE) +
  scale_fill_distiller(palette = "Spectral", type = "div", limits = c(-3,3), name="Effect") + 
...
pcr11_w_legend <- plot(sm(cr11, 2)) + l_fitRaster() + l_fitContour() + labs(title = NULL) + #l_points() +
  geom_polygon(data = map_data ("world"), 
               aes(x=long, y = lat,group=group),fill="white",color="black",
               inherit.aes = F)+coord_sf(xlim = c(-177, -158.5), ylim = c(54.5, 62), expand = FALSE) +
  scale_fill_distiller(palette = "Spectral", type = "div", limits = c(-3,3), name="Effect") + 
...
gridPrint(pcr1, pcr2, pcr3, pcr4, pcr5,
          pcr6, pcr7, pcr8, pcr9, pcr10, pcr11, ncol = 3, 
          bottom="Longitude", left="Latitude")
